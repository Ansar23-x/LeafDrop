                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 pa_left">
                                        <div class="cross_inner">
                                            <h3>Muhammad Anshar Maulidi <br><strong class="ornage_color">Product Manager</strong></h3>
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 pa_right">
                                        <div class="testomonial_img">
                                            <i><img src="{{ asset('images/niko.jpg') }}" alt="#"/></i>
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 pa_left">
                                        <div class="cross_inner">
                                            <h3>Nico Nielchen Hernanda<br><strong class="ornage_color">CEO</strong></h3>
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 pa_right">
                                        <div class="testomonial_img">
                                            <i><img src="{{ asset('images/adam.jpg') }}" alt="#"/></i>
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 pa_left">
                                        <div class="cross_inner">
                                            <h3>Adam Titan Yusuf Fernanda<br><strong class="ornage_color">CTO</strong></h3>
